    ...
    def delete(self, ident):
        ...
        try:
            if ident in members:
                ...
                resp = "MemoryDomains" + ident + " not found", 404
        except Exception:
            traceback.print_exc()
...
class MemoryDomainsCollectionAPI(Resource):
    ...
    def __init__(self):
        ...
        self.config = {
            "@odata.id": "/redfish/v1/Systems/WZP27430FB7/MemoryDomains",
    ...
    def get(self, ident):
        ...
        try:
            ...
            # if not passed:
            #     return output, 404
            # self.config["@odata.id"] = "/redfish/v1/Systems/{}/MemoryDomains".format(ident)
