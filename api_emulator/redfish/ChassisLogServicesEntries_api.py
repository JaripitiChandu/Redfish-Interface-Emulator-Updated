...
class ChassisLogServiceEntriesCollectionAPI(Resource):
    ...
    def __init__(self):
        ...
        self.config = {
           "@odata.id": "/redfish/v1/Chassis/1/LogServices/CIMC/Entries",
    ...
    def get(self,ident):
        ...
        try:
            ...
            self.config["@odata.id"] = "/redfish/v1/Chassis/1/LogServices/<string:ident>/Entries".format(ident)
